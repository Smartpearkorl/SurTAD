import sys
sys.path.append("/home/qh/TDD/strongsort_yolov9/yolov9")
...
flags.DEFINE_string('video', "/data/qh/DoTA/output/debug/visualization/videos/others/a_VxrUq9PmA_002682.mp4", 'Path to input video or webcam index (0)')
flags.DEFINE_string('output', '/home/qh/TDD/yolov9/demo_output/a_VxrUq9PmA_002682.mp4', 'path to output video')
flags.DEFINE_float('conf', 0.1, 'confidence threshold')
...
def main(_argv):
  ...
  # Load YOLO model
  weights = '/home/qh/TDD/yolov9/yolov9-c-converted.pt'
  model = DetectMultiBackend(weights=weights,device=device, fuse=True)
  model = AutoShape(model)

  # Load the COCO class labels
  classes_path = "/home/qh/TDD/strongsort_yolov9/yolov9/YOLOv9_DeepSORT/configs/coco.names"
