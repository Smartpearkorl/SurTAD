...
modelcfg_path = './configs/model/poma/vit/mem_based_detection/vit_ins_mem.py'
...
if cfg.modelcfg.proxy_task.use_ins_anomaly:
    cfg.modelcfg.proxy_task.task_names.append('instance')
    cfg.modelcfg.ano_decoder.regressor.apply_ins_cls = True
...
cfg.modelcfg.ano_decoder.compress_size = 3
cfg.modelcfg.ano_decoder.regressor.Qformer_cfg.memory_bank_length = IL(lambda c: c.modelcfg.ano_decoder.compress_size)