...
# cfg.basecfg.directly_load = "/data/qh/STDA/output/subcls,ep=24,lr=1e-5,plain/checkpoints/model-24.pt"
...
if ano_decoder == 'rnn':
    cfg.modelcfg.basic.use_ins_encoder = False
