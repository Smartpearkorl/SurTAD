...
cfg.dataset.name = 'stad'
cfg.dataset.root_path = str(DATA_FOLDER)
cfg.dataset.phase = 'train'
cfg.dataset.pre_process_type = 'rgb' # rgb or sam_emb

cfg.dataset.trans_cfg.aug_type = 'plain' # 'randaug' 'randaug'
...
cfg.dataset.trans_cfg.horizontal_flip_prob = 0.0
# random erase
